...
public class Pri_Policy extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_pri__policy);


        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);

            setContentView(R.layout.activity_pri__policy_ar);
        ...
        if (Pri_Policy.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Pri_Policy.this, About_App.class));
        finish();
    }
    ...
    private class Get_ContentPage_Data extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                brand_page_adapter = new Contant_Adapter(Pri_Policy.this, Menu_list);
                layoutManager = new LinearLayoutManager(Pri_Policy.this, LinearLayoutManager.VERTICAL, false);
