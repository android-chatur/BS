...
public class Membership_Details_Adapter extends ArrayAdapter<String> {
    ...
    public Membership_Details_Adapter(
    ...
    private View getCustomView(int position, View convertView, ViewGroup parent) {
       ...
       /* tempValues = null;
        ...
        label.setTypeface(typebold);
        label.setText(Membership_list.get(position).getxName());
