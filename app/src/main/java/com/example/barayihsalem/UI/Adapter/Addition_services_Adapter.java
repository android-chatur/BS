...
public class Addition_services_Adapter extends RecyclerView.Adapter<Addition_services_Adapter.MyViewHolder_procedBene> {
    Context context;
...
/*
    ...
    public Addition_services_Adapter(Context shopping_activity, OnItemClickListener.OnClickCallback onClickCall, ArrayList<Row> addtyiona_service_List) {
