...
public class About_Bs extends AppCompatActivity implements View.OnClickListener {
    TextView aboutbs, aboutbs_club, aboutbs_Event, settings, offer, notifi, reach_help, abou_app, oprated;
    AppController appController;
    AppPreferences appPreferences;
    SessionManager sessionManager;
    AlertDialog alertDialog;
    TextView check, no, yes;
    ImageView logoside;
    Button btnLogin;
    RecyclerView rv_drawer_list, rw_comminity;
    RelativeLayout abcd;
    LinearLayout lin_about_bs, lin_where_bs, lin_owner, lin_operator_bm, what_dose_bs, lin_engi_bs, lin_bs_new;
    ...
    OnItemClickListener.OnClickCallback onClickCall = new OnItemClickListener.OnClickCallback() {
        ...
        public void onClicked(View view, int position, String type) {
          //  if (Menu_list.get(position).getxCode().equals("Drw_1_01")) {

            if (Menu_list.get(position).getxCode().equals("Drw_1_07")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                appPreferences.save_Bs_newsBack("About");

                startActivity(new Intent(About_Bs.this, BSNews_Activity.class));
                finish();
            }else {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }
          /*  }

            if (Menu_list.get(position).getxCode().equals("Drw_1_02")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_1_03")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_1_04")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_1_05")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_1_06")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_Bs.this, What_is_BS.class));
                finish();
            }
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_about__bs);
            ...
            setContentView(R.layout.activity_about__bs_ar);
        ...
        if (About_Bs.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(About_Bs.this, DraweActivity.class));
        finish();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
          ...
          /*  case R.id.lin_about_bs:
            ...
            case R.id.lin_where_bs:
                startActivity(new Intent(About_Bs.this, Where_Is_BS.class));
                finish();
                break;

            case R.id.lin_owner:
                startActivity(new Intent(About_Bs.this, Owner_Of_BS.class));
                finish();
                break;
            case R.id.lin_operator_bm:
                startActivity(new Intent(About_Bs.this, Operator_Of_BS.class));
                finish();
                break;

            case R.id.what_dose_bs:
                startActivity(new Intent(About_Bs.this, What_Dose_BS.class));
                finish();
                break;
            case R.id.lin_engi_bs:
                startActivity(new Intent(About_Bs.this, Engi_BS.class));
                finish();
                break;

            case R.id.lin_bs_new:
                appPreferences.save_Bs_newsBack("About");
    ...
    private class Get_ContentPage_SubMenu extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                brand_page_adapter = new Drawer_Adapter(About_Bs.this, onClickCall, Menu_list);
                layoutManager = new LinearLayoutManager(About_Bs.this, LinearLayoutManager.VERTICAL, false);
