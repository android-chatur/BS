...
import com.example.barayihsalem.UI.Technology_Commu;
import com.example.barayihsalem.UI.View.OnItemClickListener;

import java.util.ArrayList;

public class Technology_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Technology_Adapter(Technology_Commu bissiness_owner, ArrayList<List> technology_List) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.techno_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.techno_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(technology_List.get(position).title);
        holder.date1.setText(technology_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = technology_List.get(position).getUrl();
