...
import com.example.barayihsalem.UI.Supplier_;
import com.example.barayihsalem.UI.View.OnItemClickListener;

import java.util.ArrayList;

public class Supplier_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    ArrayList<List> supplier_list = new ArrayList<>();
    private OnItemClickListener.OnClickCallback onClickCallback_Benefi;

    public Supplier_Adapter(Supplier_ bissiness_owner, ArrayList<List> supplier_list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.supplier_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.supplier_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(supplier_list.get(position).title);
        holder.date1.setText(supplier_list.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = supplier_list.get(position).getUrl();
