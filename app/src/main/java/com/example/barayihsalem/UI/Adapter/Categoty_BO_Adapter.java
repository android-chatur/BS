...
public class Categoty_BO_Adapter extends ArrayAdapter<String> {
    ...
    private View getCustomView(int position, View convertView, ViewGroup parent) {
       ...
       /* tempValues = null;
        ...
        label.setTypeface(typeRegular);
        label.setText( data.get(position).getxName());
