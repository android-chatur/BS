...
import com.example.barayihsalem.UI.Adapter.BoothDetailAdapter;
...
public class Event_Details extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView aboutbs, event_name, event_name_value, event_type, price_value, event_type_value, event_start_date, event_start_value, event_end_date, planner_value, email_value, price_iban, equpmentr_value,btotal_chair_value,btotal_table_value,zone_value, evenbooth_value, event_end_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_event__details_ar);
        }
        ...
        findid();
        if (Event_Details.this.isNetworkConnected()) {

            new Get_Event_Details_By_SrNo().execute();
            new Get_My_UpComing_Event_Bookings_User_Details_Booth().execute();
    ...
    private void findid() {
        ...
        btotal_chair_value.setTypeface(typeRegular);
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, UpcominiEvent_Download.class));
        finish();
    }
    ...
    private class Get_Event_Details_By_SrNo extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                builder.appendQueryParameter("StrQuery", "Sp_MyAccount_App'Get_My_UpComing_Event_Bookings_User_Details','" + appPreferences.get_detail__SRNo() + "','','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
            ...
            try {
                ...
                if (emailresponse.equals("0")) {
                    ...
                    for (int i = 0; i < result.length(); i++) {
                        ...
                        String Person_Name = collegeData.getString("Person_Name");
                        String Mobile = collegeData.getString("Mobile");
                        String SDate = collegeData.getString("Date");

                        String Currency = collegeData.getString("Currency");
                        String Business_Nature = collegeData.getString("Business_Nature");
                        String Total_Tables = collegeData.getString("Total_Tables");
                        String Total_Chairs = collegeData.getString("Total_Chairs");
                        String Equipment = collegeData.getString("Equipment");


                        //String IsCreateboothSlot = collegeData.getString("IsCreateboothSlot");
                        Double Price = collegeData.getDouble("TotalPrice");
...
*/
                        ...
                        event_name_value.setText(Person_Name);
                        event_type_value.setText(Mobile);
                        event_start_value.setText(SDate);

                        btotal_table_value.setText(Total_Tables);
                        btotal_chair_value.setText(Total_Chairs);
                        equpmentr_value.setText(Equipment);

                       // email_value.setText(Email);
                        price_iban.setText(Business_Nature);
    ...
    private class Get_My_UpComing_Event_Bookings_User_Details_Booth extends AsyncTask<String, String, String> {
        //  ProgressDialog progressDialog = new ProgressDialog(getActivity());
        HttpURLConnection conn;
        URL url = null;
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder();
                builder.appendQueryParameter("StrQuery", "Sp_MyAccount_App'Get_My_UpComing_Event_Bookings_User_Details_Booth','" + appPreferences.get_detail__SRNo() + "','','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
                String query = builder.build().getEncodedQuery();
                OutputStream os = conn.getOutputStream();
                BufferedWriter bf = new BufferedWriter(new OutputStreamWriter(os, StandardCharsets.UTF_8));
                bf.write(query);
        ...
        protected void onPostExecute(String response) {
            Gson gson = new GsonBuilder().create();
            Log.d("Get_My_UpComing_Event_Bookings_User_Details_Booth", response);
            //   progressDialog.dismiss();
            ...
            if (bsNewsPojo.success.equals(1)) {
                ...
                rw_booth_size.setLayoutManager(gridLayoutManager);
                BoothDetailAdapter membeship_adapter = new BoothDetailAdapter(Event_Details.this, Event_list);
                rw_booth_size.setAdapter(membeship_adapter);
            } else {
