...
import com.example.barayihsalem.UI.BuusiAndRetails;
...
public class Bussi_Retails_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Bussi_Retails_Adapter(BuusiAndRetails bissiness_owner, ArrayList<List> bussiness_Retails_List) {
        this.context = bissiness_owner;
        this.bussiness_Retails_List = bussiness_Retails_List;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(bussiness_Retails_List.get(position).title);
        holder.date1.setText(bussiness_Retails_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = bussiness_Retails_List.get(position).getUrl();
    ...
    public int getItemCount() {
        return bussiness_Retails_List.size();
    }
