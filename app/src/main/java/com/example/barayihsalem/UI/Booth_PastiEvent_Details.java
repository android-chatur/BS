...
public class Booth_PastiEvent_Details extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_booth__pasti_event__details);

        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            setContentView(R.layout.activity_booth__pasti_event__details_ar);
        }
        ...
        findid();
        if (Booth_PastiEvent_Details.this.isNetworkConnected()) {
