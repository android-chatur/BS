...
import com.example.barayihsalem.UI.Resident;
import com.example.barayihsalem.UI.View.OnItemClickListener;

import java.util.ArrayList;

public class Resident_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    ArrayList<List> Recident_list = new ArrayList<List>();
    private OnItemClickListener.OnClickCallback onClickCallback_Benefi;

    public Resident_Adapter(Resident bissiness_owner, ArrayList<List> Recident_list) {
        this.context = bissiness_owner;
        this.Recident_list = Recident_list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.resident_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.resident_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(Recident_list.get(position).title);
        holder.date1.setText(Recident_list.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = Recident_list.get(position).getUrl();
