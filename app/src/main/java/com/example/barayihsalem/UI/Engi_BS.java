...
public class Engi_BS extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_engi__b_s);
            ...
            setContentView(R.layout.activity_engi__b_s_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Engi_BS.this, About_Bs.class));
        finish();
    }
