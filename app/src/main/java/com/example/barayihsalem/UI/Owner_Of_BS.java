...
public class Owner_Of_BS extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_owner__of__b_s);

        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);

            setContentView(R.layout.activity_owner__of__b_s_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Owner_Of_BS.this, About_Bs.class));
        finish();
    }
