...
public class GoalsOfClub extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_goals_of_club);
            ...
            setContentView(R.layout.activity_goals_of_club_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(GoalsOfClub.this, AboutBSClub.class));
        finish();
    }
