...
import com.example.barayihsalem.UI.Passionate_Visitor;
import com.example.barayihsalem.UI.View.OnItemClickListener;

import java.util.ArrayList;

public class Passionate_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    ArrayList<List> passionate_list=new ArrayList<>();
    public Passionate_Adapter(Passionate_Visitor bissiness_owner, ArrayList<List> passionate_list) {
        this.context = bissiness_owner;
        this.passionate_list = passionate_list;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.passionate_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.passionate_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(passionate_list.get(position).title);
        holder.date1.setText(passionate_list.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = passionate_list.get(position).getUrl();
