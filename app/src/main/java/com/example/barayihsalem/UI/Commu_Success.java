...
public class Commu_Success extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        ...
        if (back==true) {
            startActivity(new Intent(Commu_Success.this, Create_Events.class));
            finish();
        }else {
            startActivity(new Intent(Commu_Success.this, Book_Location_Events.class));
            finish();
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_home:
                my_acount=false;
                startActivity(new Intent(Commu_Success.this, Create_Booth_Slot.class));
                finish();
                break;
        }
    }
