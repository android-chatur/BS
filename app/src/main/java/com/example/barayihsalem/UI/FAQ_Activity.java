...
public class FAQ_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_f_a_q_ar);
        ...
        findid();
        if (FAQ_Activity.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(FAQ_Activity.this, Reach_Us_help.class));
        finish();
    }
    ...
    private class Get_ContentPage_Data extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                brand_page_adapter = new Contant_Adapter(FAQ_Activity.this, Menu_list);
                layoutManager = new LinearLayoutManager(FAQ_Activity.this, LinearLayoutManager.VERTICAL, false);
