...
public class Benfit_Rewardss_Club extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_benfit__rewardss__club);
            ...
            setContentView(R.layout.activity_benfit__rewardss__club_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Benfit_Rewardss_Club.this, AboutBSClub.class));
        finish();
    }
