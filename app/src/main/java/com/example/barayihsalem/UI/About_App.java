...
public class About_App extends AppCompatActivity implements View.OnClickListener {
    ...
    RelativeLayout abcd;
    LinearLayout lin_complain, lin_pri_police, lin_opinion, lin_older_events_gallary;
    ...
    OnItemClickListener.OnClickCallback onClickCall = new OnItemClickListener.OnClickCallback() {
        ...
        public void onClicked(View view, int position, String type) {
            ...
            if (Menu_list.get(position).getxCode().equals("Drw_8_01")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                appPreferences.savesuggetion("opinion");

                if (appPreferences.getCulturemode().equals("1")) {
                    startActivity(new Intent(About_App.this, Suggestion.class).putExtra("key", "Share Your opinion about the App."));
                    finish();
                } else {
                    startActivity(new Intent(About_App.this, Suggestion.class).putExtra("key", "شاركنا برأيك حول التطبيق"));
                    finish();
                }
            }


            if (Menu_list.get(position).getxCode().equals("Drw_8_02")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_App.this, Pri_Policy.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_8_03")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_App.this, Pri_Policy.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_8_04")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_App.this, Pri_Policy.class));
                finish();
            }

            if (Menu_list.get(position).getxCode().equals("Drw_8_05")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_App.this, Pri_Policy.class));
                finish();
            }
            if (Menu_list.get(position).getxCode().equals("Drw_8_06")) {
                appPreferences.SaveDrawerXcode_Sub(Menu_list.get(position).getxCode());
                startActivity(new Intent(About_App.this, Pri_Policy.class));
                finish();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_about__app_ar);
        ...
        findid();
        if (About_App.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(About_App.this, DraweActivity.class));
        finish();
    }
    ...
    private class Get_ContentPage_SubMenu extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                brand_page_adapter = new Drawer_Adapter(About_App.this, onClickCall, Menu_list);
                layoutManager = new LinearLayoutManager(About_App.this, LinearLayoutManager.VERTICAL, false);
