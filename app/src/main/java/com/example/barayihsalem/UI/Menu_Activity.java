...
public class Menu_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView lnewly, shushi, lne, dd, txtlab;
    ...
    OnItemClickListener.OnClickCallback onClickCall = new OnItemClickListener.OnClickCallback() {
        ...
        public void onClicked(View view, int position, String type) {
            ...
            if (Menu_list != null && Menu_list.size() > 0) {
                ...
                startActivity(new Intent(Menu_Activity.this, Dish_Detail_Activity.class));
                finish();
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       ;
        ...
        if (Menu_Activity.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(Menu_Activity.this, Restaurant_Details.class));
        finish();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.sortfilt:
                filte=false;
                appPreferences.saveBafilte("Menu_Activity");

                startActivity(new Intent(Menu_Activity.this, Filter_Activity.class));
                finish();
                break;
            ...
            case R.id.seach:
                retail=false;
                appPreferences.save_AddBackSeach("Menu_Activity");

                startActivity(new Intent(Menu_Activity.this, Search_Shopping.class));
                finish();
                break;
        }
    }
    ...
    private class Get_Store_Menu_Wise_ItemList_By_SrNo extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                if (filte==true){
                    builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Store_Menu_Wise_ItemList_By_SrNo','" + appPreferences.geStore_SrNo() + "','" + appPreferences.geShoppingSrno() + "','" + appPreferences.getMenu_Sxcode() + "','','','"+appPreferences.getfilter_sort()+"','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");

                }else{
                    builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Store_Menu_Wise_ItemList_By_SrNo','" + appPreferences.geStore_SrNo() + "','" + appPreferences.geShoppingSrno() + "','" + appPreferences.getMenu_Sxcode() + "','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                allMenu_adapter = new Menu_Adapter(Menu_Activity.this, onClickCall,Menu_list);
                layoutManager = new LinearLayoutManager(Menu_Activity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private class Get_Store_Menu_List_By_SrNo extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                nationality_adapter = new Nationality_Adapter(Menu_Activity.this, R.layout.countryspinner_country_new, Nationality_list, res);
