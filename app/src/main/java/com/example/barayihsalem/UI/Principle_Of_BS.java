...
public class Principle_Of_BS extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_principle__of__b_s);
            ...
            setContentView(R.layout.activity_principle__of__b_s_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Principle_Of_BS.this, AboutBSClub.class));
        finish();
    }
