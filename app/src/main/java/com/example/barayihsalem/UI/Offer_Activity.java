          ...
          /*  case R.id.lin_service_offers:
            ...
            case R.id.lin_shoping_offer:
                if (appPreferences.getCulturemode().equals("1")) {
                    ...
                    startActivity(new Intent(Offer_Activity.this, Shoping_Offer.class).putExtra("key", "عروض التسوق"));
                    finish();
                }
            ...
            case R.id.lin_groceries_offer:
                if (appPreferences.getCulturemode().equals("1")) {
                    ...
                    startActivity(new Intent(Offer_Activity.this, Shoping_Offer.class).putExtra("key", "عرض البقالة"));
                    finish();
                }
            ...
            case R.id.lin_registerat_event:
                if (appPreferences.getCulturemode().equals("1")) {
                    ...
                    startActivity(new Intent(Offer_Activity.this, Shoping_Offer.class).putExtra("key", "عروض المطاعم"));
                    finish();
                }
