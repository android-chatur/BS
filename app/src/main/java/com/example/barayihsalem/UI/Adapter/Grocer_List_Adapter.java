...
public class Grocer_List_Adapter extends RecyclerView.Adapter<Grocer_List_Adapter.OffersProduct_ada_ad> {
    AppController appController;
    Typeface typeSemibold, typeRegular, typeHeader, heding, normal, typebold, LoraNormal;
    TextView tvName, tv_deli_time, tv_name_sub;
    ImageView ivImage;
    ...
    public Grocer_List_Adapter(Context context, OnItemClickListener.OnClickCallback onClickCall_resta) {
    ...
    @NonNull
    @Override
    public Grocer_List_Adapter.OffersProduct_ada_ad onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.grocery_list, parent, false);
        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.grocery_list, parent, false);

        }
        return new Grocer_List_Adapter.OffersProduct_ada_ad(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Grocer_List_Adapter.OffersProduct_ada_ad holder, final int position) {
