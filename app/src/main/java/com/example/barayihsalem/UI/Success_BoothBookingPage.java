...
public class Success_BoothBookingPage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Success_BoothBookingPage.this.isNetworkConnected()) {

            new Get_Booth_Booking_Result_Details().execute();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Success_BoothBookingPage.this, HomeActivity.class));
        finish();
    }
    ...
    private class  Get_Booth_Booking_Result_Details extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Booth_Booking_Result_Details','" + appPreferences.get_Attribute_Book()  + "','"+appPreferences.get_trackid_Book()+"','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
