...
public class UpcominiPastEvent_Details extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_upcomini_past_event__details);

        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            setContentView(R.layout.activity_upcomini_past_event__details_ar);
        }
        ...
        if (UpcominiPastEvent_Details.this.isNetworkConnected()) {
