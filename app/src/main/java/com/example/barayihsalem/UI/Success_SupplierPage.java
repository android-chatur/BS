...
public class Success_SupplierPage extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Success_SupplierPage.this.isNetworkConnected()) {

            new Get_Confirm_Boost_Your_Sale_Price_Details().execute();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Success_SupplierPage.this, HomeActivity.class));
        finish();
    }
    ...
    private class Get_Confirm_Boost_Your_Sale_Price_Details extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Boost_Your_Sale_Result_Details','" + appPreferences.get_Attribute_Supp() + "','"+appPreferences.get_track_id()+"','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
