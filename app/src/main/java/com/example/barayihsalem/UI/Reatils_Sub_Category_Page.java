...
public class Reatils_Sub_Category_Page extends AppCompatActivity implements View.OnClickListener {
    private static ViewPager mPager;
    TextView txtlab, tx_cy, tx_cate, tx_food, tx_Brand, tx_depat, tx_cancel;
    AppController appController;
    AppPreferences appPreferences;
    public static  boolean isgrosary=false;
    ...
    OnItemClickListener.OnClickCallback onClickCall = new OnItemClickListener.OnClickCallback() {
        ...
        public void onClicked(View view, int position, String type) {
            isedit=true;
            appPreferences.AddressBack("Reatils_Sub_Category_Page");

            appPreferences.SaveAddressXcode(bottom_list.get(position).getxCode());
            startActivity(new Intent(Reatils_Sub_Category_Page.this, Enter_Address.class));
            finish();
    ...
    OnItemClickListener.OnClickCallback onClickCall_resta = new OnItemClickListener.OnClickCallback() {
        ...
        public void onClicked(View view, int position, String type) {
            ...
            startActivity(new Intent(Reatils_Sub_Category_Page.this, Retails_Details.class));
            finish();
    ...
    Retails_Adapter resta_food_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_reatils__sub__category__page);


        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);

            setContentView(R.layout.activity_reatils__sub__category__page_ar);
        ...
        txtlab.setText(appPreferences.geRetailname());


        if (Reatils_Sub_Category_Page.this.isNetworkConnected()) {
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, Reatils_category_page.class));
        finish();
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.lin_seeall_grocery:
                isgrosary=false;
                startActivity(new Intent(this, All_Retails.class));
                finish();
                break;
        }
    }
    ...
    private void showBottomSheetDialog() {
        {
            View view;
            if (appPreferences.getCulturemode().equals("1")) {
                view = LayoutInflater.from(Reatils_Sub_Category_Page.this).inflate(R.layout.changeaddress_dialog, null);

            } else {
                view = LayoutInflater.from(Reatils_Sub_Category_Page.this).inflate(R.layout.changeaddress_dialog_ar, null);
            ...
            dialog = new BottomSheetDialog(Reatils_Sub_Category_Page.this);
            dialog.setContentView(view);
            dialog.show();

            address_adapter = new Address_Adapter_inner(Reatils_Sub_Category_Page.this, onClickCall,bottom_list);
            colorred = true;
            layoutManager = new LinearLayoutManager(Reatils_Sub_Category_Page.this, LinearLayoutManager.VERTICAL, false);
    ...
    private class Get_Top10_All_Store_list_By_Category extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Top10_All_Store_list_By_Category','" + appPreferences.geShoppingSrno() + "','"+appPreferences.geRetailSrno()+"','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                resta_food_adapter = new Retails_Adapter(Reatils_Sub_Category_Page.this, onClickCall_resta,Shopping_list);
                layoutManager = new LinearLayoutManager(Reatils_Sub_Category_Page.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    private class Get_Category_Wise_Banner extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                Uri.Builder builder = new Uri.Builder();
                builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_Category_Wise_Banner','" + appPreferences.geShoppingSrno() + "','"+appPreferences.geRetailSrno()+"','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
                String query = builder.build().getEncodedQuery();
                OutputStream os = conn.getOutputStream();
                BufferedWriter bf = new BufferedWriter(new OutputStreamWriter(os, StandardCharsets.UTF_8));
                bf.write(query);
        ...
        protected void onPostExecute(String response) {
            ...
            VisionspinnerPojo partnerPojo = new Gson().fromJson(response, VisionspinnerPojo.class);
            if (partnerPojo.success.equals(1)) {
                // Toast.makeText(appController, partnerPojo.message, Toast.LENGTH_SHORT).show();dis
