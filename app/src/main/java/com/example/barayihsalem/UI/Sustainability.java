...
public class Sustainability extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_sustainability_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Sustainability.this, AboutBSClub.class));
        finish();
    }
