...
import com.example.barayihsalem.UI.Creative_Commu;
...
public class Creative_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Creative_Adapter(Creative_Commu exchage_list, ArrayList<List> creative_List) {
        this.context = exchage_list;
        this.creative_List = creative_List;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.vision_list, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(creative_List.get(position).title);
        holder.date1.setText(creative_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = creative_List.get(position).getUrl();
