...
public class Shopping_Adapter extends RecyclerView.Adapter<Shopping_Adapter.MyViewHolder_procedBene> {
    Context context;
  ...
  //  private OnItemClickListener.OnClickCallback onClickCallback_Benefi;
    ...
    public Shopping_Adapter(Shopping_Activity exchage_list) {
