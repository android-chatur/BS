...
import com.example.barayihsalem.UI.VisionPartner;

import java.util.ArrayList;

public class Visipart_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    ArrayList<List> vision_list = new ArrayList<>();
    private OnItemClickListener.OnClickCallback onClickCallback_Benefi;

    public Visipart_Adapter(VisionPartner exchage_list, ArrayList<List> vision_list) {
