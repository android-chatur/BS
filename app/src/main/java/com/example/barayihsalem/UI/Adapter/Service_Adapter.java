...
import com.example.barayihsalem.UI.Service_Details;
import com.example.barayihsalem.UI.View.OnItemClickListener;

import java.util.ArrayList;

public class Service_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Service_Adapter(Service_Details bissiness_owner, ArrayList<List> service_List) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.service_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.service_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(service_List.get(position).title);
        holder.date1.setText(service_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = service_List.get(position).getUrl();
