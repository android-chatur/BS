...
import com.example.barayihsalem.UI.Entertainment_Community;
...
public class Entertainment_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Entertainment_Adapter(Entertainment_Community bissiness_owner, ArrayList<List> entertainment_List) {
        this.context = bissiness_owner;
        this.entertainment_List = entertainment_List;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(entertainment_List.get(position).title);
        holder.date1.setText(entertainment_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = entertainment_List.get(position).getUrl();
    ...
    public int getItemCount() {
        return entertainment_List.size();
    }
