...
public class Membership_Club extends AppCompatActivity implements View.OnClickListener {
    TextView aboutbs, aboutbs_club, abou, supp_services, ambassador, residence, bussi_owner, mem_vispart, oprated;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_membership__club);

        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);

            setContentView(R.layout.activity_membership__club_ar);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Membership_Club.this, AboutBSClub.class));
        finish();
    }
