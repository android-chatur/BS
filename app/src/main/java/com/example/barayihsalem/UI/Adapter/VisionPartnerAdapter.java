...
public class VisionPartnerAdapter extends ArrayAdapter<String> {
    ...
    ArrayList<Row> spinner_list=new ArrayList<>();
    //   private CountryModel tempValues = null;
    private LayoutInflater inflater;

    /*************  CustomAdapter Constructor *****************/
    public VisionPartnerAdapter(
    ...
    private View getCustomView(int position, View convertView, ViewGroup parent) {
       ...
       /* tempValues = null;
        ...
        label.setText( spinner_list.get(position).xName);
