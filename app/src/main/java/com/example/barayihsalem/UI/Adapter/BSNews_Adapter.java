...
public class BSNews_Adapter extends RecyclerView.Adapter<BSNews_Adapter.MyViewHolder_procedBene> {
    Context context;
    ...
    public BSNews_Adapter(BSNews_Activity exchage_list, ArrayList<Row> news_list, OnItemClickListener.OnClickCallback onClickCall) {
