...
public class Booth_UpcommingEvent_Adapter extends RecyclerView.Adapter<Booth_UpcommingEvent_Adapter.OffersProduct_ada_ad> {
    ...
    Booth_SubUpcoming_eventAdapter booth_subUpcoming_eventAdapter;
    ...
    public Booth_UpcommingEvent_Adapter(Context context, OnItemClickListener.OnClickCallback onClickCall_boothUpcomingEvent, ArrayList<Row> booth_In_UpComing_Event_List) {
        this.context = context;
        this.onClickCallback_Benefi = onClickCall_boothUpcomingEvent;
    ...
    public void onBindViewHolder(@NonNull OffersProduct_ada_ad holder, final int position) {
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            event_name.setText("Event" + " " + booth_In_UpComing_Event_List.get(position).getSr());


        } else {


            event_name.setText("الأحداث " + " " + booth_In_UpComing_Event_List.get(position).getSr());
        ...
        booth_subUpcoming_eventAdapter = new Booth_SubUpcoming_eventAdapter(context, onClickCallback_Benefi,booth_In_UpComing_Event_List);
        rw_eventlist.setAdapter(booth_subUpcoming_eventAdapter);
