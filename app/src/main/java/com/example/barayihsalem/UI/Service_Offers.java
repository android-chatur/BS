...
public class Service_Offers extends AppCompatActivity implements View.OnClickListener {
    ...
    Contant_Adapter brand_page_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_service__offers);
            ...
            setContentView(R.layout.activity_service__offers_ar);
        ...
        findid();
        if (Service_Offers.this.isNetworkConnected()) {
    ...
    private void findid() {
        ...
        lin_service_offers = findViewById(R.id.lin_service_offers);
        ...
        lin_service_offers.setOnClickListener(this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Service_Offers.this, Offer_Activity.class));
        finish();
    }
    ...
    private class Get_ContentPage_Data extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                builder.appendQueryParameter("StrQuery", "Sp_Index_Mst_App'Get_ContentPage_Data','" + appPreferences.get_DrawerXcode() + "','" + appPreferences.get_Xcode_Sub() + "','','','','','" + appPreferences.getuserid() + "','" + appPreferences.getCulturemode() + "','" + appPreferences.get_company_id() + "'");
        ...
        protected void onPostExecute(String response) {
            ...
            if (partnerPojo.success.equals(1)) {
                ...
                brand_page_adapter = new Contant_Adapter(Service_Offers.this, Menu_list);
                layoutManager = new LinearLayoutManager(Service_Offers.this, LinearLayoutManager.VERTICAL, false);
