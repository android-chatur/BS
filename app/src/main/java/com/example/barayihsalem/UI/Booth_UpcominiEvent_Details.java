...
public class Booth_UpcominiEvent_Details extends AppCompatActivity implements View.OnClickListener {

    TextView aboutbs, event_name, event_name_value, event_type, event_type_value, event_start_date, event_start_value, event_end_date, event_end_value;
    TextView booth_type, bot_type_value, zone, zone_value, event_planner_moble, iban_value, event_planner_moble_value, event_email, email_value, event_price, price_value, event_iban;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_booth__upcomini_event__details);


        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            setContentView(R.layout.activity_booth__upcomini_event__details_ar);
        }
        ...
        findid();
        if (Booth_UpcominiEvent_Details.this.isNetworkConnected()) {
    ...
    private void findid() {
        ...
        bot_type_value = findViewById(R.id.bot_type_value);
        event_email = findViewById(R.id.event_email);
        email_value = findViewById(R.id.email_value);
        event_planner_moble = findViewById(R.id.event_planner_moble);
        event_planner_moble_value = findViewById(R.id.event_planner_moble_value);
        iban_value = findViewById(R.id.iban_value);
        ...
        event_iban = findViewById(R.id.event_iban);
        ...
        event_email.setTypeface(typeHeader);
        booth_type.setTypeface(typeHeader);
        email_value.setTypeface(typeHeader);
        event_price.setTypeface(typeHeader);
        bot_type_value.setTypeface(typeHeader);
        price_value.setTypeface(typeHeader);
        event_planner_moble_value.setTypeface(typeHeader);
        zone_value.setTypeface(typeHeader);
        event_planner_moble.setTypeface(typeHeader);
        zone.setTypeface(typeHeader);
        event_iban.setTypeface(typeHeader);
        iban_value.setTypeface(typeHeader);
            ...
            try {
                ...
                if (emailresponse.equals("0")) {
                    ...
                    for (int i = 0; i < result.length(); i++) {
                        ...
                        bot_type_value.setText(BoothTypes);
                        zone_value.setText(Zones);
                        event_planner_moble_value.setText(EventPlanner_Mobile);
                        email_value.setText(Email);
                        iban_value.setText(IBAN);
