...
import com.example.barayihsalem.UI.Reatils_category_page;
...
public class RetailPage_Adapter extends RecyclerView.Adapter<Shopping_ViewHolder> {
    ...
    public RetailPage_Adapter(Reatils_category_page shopping_category_page, ArrayList<Row> shopping_list, OnItemClickListener.OnClickCallback onClickCall_shopping) {
    ...
    public Shopping_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.retail_list, parent, false);
        } else {
    ...
    public void onBindViewHolder(@NonNull Shopping_ViewHolder holder, final int position) {
      ...
      /*  Picasso.with(context)
                .load(context.getResources().getString(R.string.Sector) + shopping_list.get(position).getImage())
        ...
        String asd = shopping_list.get(position).getImage();

        Glide.with(context)
                .load(context.getResources().getString(R.string.Sector) + shopping_list.get(position).getImage1())
