...
import com.example.barayihsalem.UI.Model.Color;
import com.example.barayihsalem.UI.Model.Row;
import com.example.barayihsalem.UI.Model.Size;

import java.util.ArrayList;
import java.util.List;

public class Size_Adapter extends ArrayAdapter<String> {
    ...
    ArrayList<Size> Nationality_list = new ArrayList<Size>();
