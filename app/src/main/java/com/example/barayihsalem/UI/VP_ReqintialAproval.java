...
public class VP_ReqintialAproval extends AppCompatActivity implements View.OnClickListener, TabLayout.BaseOnTabSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            setContentView(R.layout.activity_v_p__reqintial_aproval);


        } else {
            getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);

            setContentView(R.layout.activity_v_p__reqintial_aproval_ar);
...
/*
    ...
    private void findid() {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            adapter.addFragment(new NewEntry(), "New Login");
            adapter.addFragment(new Recornded(), "Logged in");
            myDietTab = tabLayout.newTab();
             myWorkOutTab = tabLayout.newTab();
            myDietTab.setText("New Login");
            myWorkOutTab.setText("Logged in");
        }else {
            adapter.addFragment(new NewEntry(), "سجيل دخول جديد");
            adapter.addFragment(new Recornded(), "تم التسجيل");
            myDietTab = tabLayout.newTab();
            myWorkOutTab = tabLayout.newTab();
    ...
    public void onBackPressed() {
        startActivity(new Intent(VP_ReqintialAproval.this, HomeActivity.class));
        finish();
    }
