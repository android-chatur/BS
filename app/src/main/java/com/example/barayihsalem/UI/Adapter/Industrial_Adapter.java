...
import com.example.barayihsalem.UI.Industrial_Commu;
...
public class Industrial_Adapter extends RecyclerView.Adapter<MyViewHolder> {
    Context context;
    ...
    public Industrial_Adapter(Industrial_Commu bissiness_owner, ArrayList<List> industrial_List) {
        this.context = bissiness_owner;
        this.industrial_List = industrial_List;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (appPreferences.getCulturemode().equals("1")) {
            ...
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.indust_list, parent, false);

        } else {
            ((Activity) context).getWindow().getDecorView().setLayoutDirection(View.LAYOUT_DIRECTION_RTL);
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.indust_list_ar, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.date.setText(industrial_List.get(position).title);
        holder.date1.setText(industrial_List.get(position).getDescription());
        ...
        holder.date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Url = industrial_List.get(position).getUrl();
